...
public class ModPaintings {
    ...
    public static final ResourceKey<PaintingVariant> RUBY_SAPPHIRE_KEY = create("ruby_sapphire");

    public static void bootstrap(BootstrapContext<PaintingVariant> context) {
        register(context, RUBY_SAPPHIRE_KEY, 4, 2, true);
    }

    private static ResourceKey<PaintingVariant> create(final String id) {
        return ResourceKey.create(Registries.PAINTING_VARIANT, Identifier.fromNamespaceAndPath(GemColony.MOD_ID, id));
    }
